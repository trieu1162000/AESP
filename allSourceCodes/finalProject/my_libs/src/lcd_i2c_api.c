...
static void lcdClearDisplay(struct lcd_i2c *lcd)
{
...
static void lcdClearLine(struct lcd_i2c *lcd)
{
...
void lcdFlush(struct lcd_i2c *lcd)
{
...
void lcdWrite(struct lcd_i2c *lcd, const char *buf, size_t count)
{
    size_t i;
    char ch;
...
void lcdSetGeometry(struct lcd_i2c *lcd, struct lcd_i2c_geometry *geo)
{
    lcd->geometry = geo;
...
void lcdInit(struct lcd_i2c *lcd)
{
